<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="start_workflow.aspx.cs" Inherits="DMS.start_workflow" %>
                    ...
                    <div class="wf_mas_doc_holder_padd">
                        ...
                        <div class="normal_common">
                            ...
                            <span class="wf_det_add_holder"> 
                                <asp:Button ID="cmdStartWF" runat="server" CssClass="wf_mas_add" Text="Start Workflow" onclick="cmdStartWF_Click" />
                            </span>
                        </div>
                    </div>
                </div>
