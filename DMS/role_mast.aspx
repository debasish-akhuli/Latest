<%@ Page Title="myDOCbase" Language="C#" MasterPageFile="adm_mast_entry.Master" AutoEventWireup="true" CodeBehind="role_mast.aspx.cs" Inherits="DMS.role_mast" %>
            ...
            <div class="normal_common">
                <div class="wf_mas_doc_holder" style="min-height:300px;">
                    <div class="wf_mas_doc_holder_padd">
                        ...
                        <div class="normal_common">
                            <span class="wf_mas_cap">Role Code</span>
                            <asp:TextBox ID="txtRoleCode" MaxLength="20" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                            <span style="padding-left:5px; float:left; font-weight:bold; font-size:24px; color:Red;">*</span>
                        </div>
                        <div class="normal_common">
                            <span class="wf_mas_cap">Role Name</span>
                            <asp:TextBox ID="txtRoleName" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                            <span style="padding-left:5px; float:left; font-weight:bold; font-size:24px; color:Red;">*</span>
                        ...
                        <div style="margin-top:20px;" class="normal_common">
                            <div style="overflow:auto; height:300px;">
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Role Code" HeaderStyle-Width="200" ItemStyle-Width="200">
                                    <ItemTemplate ><%#Eval("role_id")%></ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Role Name" HeaderStyle-Width="500" ItemStyle-Width="500" >
                                    <ItemTemplate > <%#Eval("role_name")%></ItemTemplate>
                                    <EditItemTemplate>
                                    <asp:TextBox ID="txtEditRoleName" runat="server" Text='<%#Eval("role_name")%>' Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
