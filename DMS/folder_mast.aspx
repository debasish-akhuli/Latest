<%@ Page Title="myDOCbase" Language="C#" MasterPageFile="adm_mast_entry.Master" AutoEventWireup="true" CodeBehind="folder_mast.aspx.cs" Inherits="DMS.folder_mast" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function FormValidation() {
            if (document.getElementById("<%=txtFldName.ClientID %>").value.trim() == "") {
                alert("Please Enter Folder Name");
                document.getElementById("<%=txtFldName.ClientID %>").focus();
                return false;
            }
            else if (document.getElementById("<%=txtFldDesc.ClientID %>").value.trim() == "") {
                alert("Please Enter Folder Description");
                document.getElementById("<%=txtFldDesc.ClientID %>").focus();
                return false;
            }
            else {
                return true;
            ...
            <div class="normal_common">
                <div class="wf_mas_doc_holder" style="min-height:300px;">
                    ...
                    <div style="float:left; width:50%;">
                        ...
                        <div class="normal_common">
                            <span class="wf_mas_cap">Folder Name</span>
                            <asp:TextBox ID="txtFldName" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                            <span style="padding-left:5px; float:left; font-weight:bold; font-size:24px; color:Red;">*</span>
                        </div>
                        <div class="normal_common">
                            <span class="wf_mas_cap">Folder Description</span>
                            <asp:TextBox ID="txtFldDesc" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                            <span style="padding-left:5px; float:left; font-weight:bold; font-size:24px; color:Red;">*</span>
                        </div>
                        <div class="normal_common" style="display:none;">
                            <span class="wf_mas_cap">Selected Drawer</span>
                        ...
                        <div class="normal_common">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">                                
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddDrawer" CssClass="wf_det_field2_big" runat="server"></asp:DropDownList>
                                    <span style="padding-left:5px; float:left; font-weight:bold; font-size:24px; color:Red;">*</span>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                        <div class="normal_common" style="display:none;">
                            <span class="wf_mas_cap"> </span>
                            <asp:CheckBox ID="chkTemp" runat="server" Text=" Create TEMPX Folder" Checked="false" />
                        </div>
                        <div class="normal_common">
                        ...
                        <div style="margin-top:20px;" class="normal_common">
                            <div style="overflow:auto; height:300px;">
                                ...
                                <ContentTemplate>
                                    ...
                                    <ItemTemplate >    
                                    <asp:Label ID="lbAutoID" runat="server" Text='<%#Eval("fld_uuid")%>' ></asp:Label>
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cabinet" HeaderStyle-Width="150" ItemStyle-Width="150">  
                                    <ItemTemplate ><%#Eval("cab_name")%></ItemTemplate>
                                    <%--<EditItemTemplate>
                                    <asp:DropDownList ID="ddlEditCabinet"  AutoPostBack="true" OnSelectedIndexChanged="ddlEditCabinet_SelectedIndexChanged"  CssClass="wf_det_field2" runat="server" Width="100%"></asp:DropDownList>
                                    ...
                                    <asp:TemplateField HeaderText="Drawer" HeaderStyle-Width="200" ItemStyle-Width="200">  
                                    <ItemTemplate ><%#Eval("drw_name")%></ItemTemplate>
                                    <%--<EditItemTemplate>
                                    <asp:DropDownList ID="ddlEditDrawer"  CssClass="wf_det_field2" runat="server" Width="100%"></asp:DropDownList>
                                    <asp:HiddenField ID="hdDrawer" runat="server" Value='<%#Eval("drw_name")%>' />
                                    </EditItemTemplate>--%>
                                    <HeaderStyle Width="150px" HorizontalAlign="Left" CssClass="GVRec"></HeaderStyle>
                                    <ItemStyle Width="150px" HorizontalAlign="Left" CssClass="GVRec"></ItemStyle>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Folder Name" HeaderStyle-Width="150" ItemStyle-Width="150">  
                                    <ItemTemplate ><%#Eval("fld_name")%></ItemTemplate>
                                    <%--<EditItemTemplate>
                                    <asp:TextBox ID="txtEditFldName" runat="server" CssClass="wf_mas_field" Text='<%#Eval("fld_name")%>' Width="100%"></asp:TextBox>                                    
                                    </EditItemTemplate>--%>
                                    <HeaderStyle Width="150px" HorizontalAlign="Left" CssClass="GVRec"></HeaderStyle>
                                    <ItemStyle Width="150px" HorizontalAlign="Left" CssClass="GVRec"></ItemStyle>
                                    </asp:TemplateField>                                    
                                    <asp:TemplateField HeaderText="Folder Description" HeaderStyle-Width="350" ItemStyle-Width="350">
                                    <ItemTemplate > <%#Eval("fld_desc")%></ItemTemplate>
                                    <EditItemTemplate>
                                    <asp:HiddenField ID="hdCabinet" runat="server" Value='<%#Eval("cab_name")%>' />
                                    <asp:HiddenField ID="hdDrawer" runat="server" Value='<%#Eval("drw_name")%>' />
                                    <asp:TextBox ID="txtEditFldDesc" runat="server" CssClass="wf_mas_field" Text='<%#Eval("fld_desc")%>' Width="100%"></asp:TextBox>                                    
                                    </EditItemTemplate>
                                    <HeaderStyle Width="350px" HorizontalAlign="Left" CssClass="GVRec"></HeaderStyle>
                                    <ItemStyle Width="350px" HorizontalAlign="Left" CssClass="GVRec"></ItemStyle>
                                    </asp:TemplateField>
