<%@ Page Title="myDOCbase" Language="C#" MasterPageFile="adm_mast_entry.Master" AutoEventWireup="true" CodeBehind="eFormEditing.aspx.cs" Inherits="DMS.eFormEditing" %>
            ...
            <div class="normal_common">
                <div class="wf_mas_doc_holder" style="min-height:300px;">
                        ...
                        <div class="right_part">
                            <div class="normal_common" style="padding-top:10px; background:#dddddd;">
                                ...
                                <span style="float:left; padding-left:10px;" id="span2">
                                    <asp:Button ID="cmdUpdate" runat="server" CssClass="btn" Text="Update" OnClick="cmdUpdate_Click" OnClientClick="javascript: return ButtonStatus('S')" />
                                </span>
