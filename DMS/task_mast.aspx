<%@ Page Title="myDOCbase" Language="C#" MasterPageFile="adm_mast_entry.Master" AutoEventWireup="true" CodeBehind="task_mast.aspx.cs" Inherits="DMS.task_mast" %>
            ...
            <div class="normal_common">
                <div class="wf_mas_doc_holder" style="min-height:300px;">
                    <div class="wf_mas_doc_holder_padd">
                        <div class="normal_common">
                            <span class="wf_mas_cap">Task Code</span>
                            <asp:TextBox ID="txtTaskCode" MaxLength="10" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                        </div>
                        <div class="normal_common">
                            <span class="wf_mas_cap">Task Name</span>
                            <asp:TextBox ID="txtTaskName" runat="server" CssClass="wf_mas_field"></asp:TextBox>
                        ...
                        <div style="margin-top:20px;" class="normal_common">
                            <div style="overflow:auto; height:300px;">
                                ...
                                <ContentTemplate>
                                    ...
                                    <ItemTemplate >
                                    <asp:Label ID="lbAutoID" runat="server" Text='<%#Eval("task_id")%>' ></asp:Label>
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Task Code" HeaderStyle-Width="200" ItemStyle-Width="200">  
                                    <ItemTemplate ><%#Eval("task_id")%></ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Task Name" HeaderStyle-Width="500" ItemStyle-Width="500" >  
                                    <ItemTemplate > <%#Eval("task_name")%></ItemTemplate>
                                    <EditItemTemplate>
                                    <asp:TextBox ID="txtEditTaskName" runat="server" Text='<%#Eval("task_name")%>' Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
